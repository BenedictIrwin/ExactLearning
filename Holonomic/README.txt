...
Once we have solved for the matrix, it might be easier to consider variations
of phi or even solve the shift equation/equivalent differential equation
directly by inverting. 

Does this also mean that the Matrix M, directly encodes the function?
