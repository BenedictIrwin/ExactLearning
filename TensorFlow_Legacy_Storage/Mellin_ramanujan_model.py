...
def main():
  ...
  matrix_V = tf.get_variable(name="V", dtype=tf.float32, shape=[hypergeom_p, num_dim], initializer=matrix_M_init)
  matrix_W = tf.get_variable(name="W", dtype=tf.float32, shape=[hypergeom_q, num_dim], initializer=matrix_M_init)
  ...
  num_train_exponent_samples = 1000
  ...
  with tf.Session() as sess:
    ...
    s_list = [[1.0]]+np.random.uniform(1.0,20.0,size=[num_train_exponent_samples,num_dim])
