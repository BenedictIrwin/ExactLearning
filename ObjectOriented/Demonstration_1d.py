...
EE.set_fingerprint( gen_fpdict(['c','neg-P1']))
n_bfgs = 10
for i in range(n_bfgs): 
  EE.BFGS(order=2)
  print("{}%".format(100*(i+1)/n_bfgs),flush=True)
...
EE = ExactEstimator("Wandering_Point", folder = "Wandering_Point")
EE.set_fingerprint( gen_fpdict(['c','alt-linear-gamma','linear-gamma','neg-linear-gamma','neg-shift-gamma']))
